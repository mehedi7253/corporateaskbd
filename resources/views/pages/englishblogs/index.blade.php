            ...
            <div class="col-md-12 col-sm-12 mb-3">
                ...
                <div class="col-md-6 col-sm-12 float-left mt-3">
                    <div class="card" id="blog">
                        <img src="{{ asset('blog/images/'.$blog->blog_image) }}" class="card-img-top"  alt="{{ $blog->blog_name }}" style="border-top-right-radius: 8px; border-top-left-radius: 8px; height: 240px;">
                        <div class="card-body">
                            <h1 style="font-size: 28px"><a href="{{ route('blog.enblogshow', ['ename'=>$blog->url]) }}" class="text-decoration-none" style="font-family: 'Hind Siliguri'; font-size: 22px">{{ $blog->blog_name }}</a></h1>
                            ...
                            <div class="p-2">
                                <p class="text-justify" style="font-family: 'Hind Siliguri'; font-size: 22px">
                                    ...
                                    @endphp
                                    <a href="{{ route('blog.enblogshow', ['ename'=>$blog->url]) }}">...Read More</a>
                                </p>
                            </div>
                        </div>
