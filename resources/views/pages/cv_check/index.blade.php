...
@section('content')
    <div class="" id="particles-js">
        <div class="heading">
            <h1 class="text-center text-white package_name" style="margin-top: 5%">CV/Resume Checking</h1>
                ...
                @foreach($services as $service)
                    <div class="col-md-4 col-sm-12 float-left">
                        <div class="card mt-4" style="border: 2px solid red; border-radius: 10px">
                            ...
                            <a href="{{ route('cvcheck.cvheckShow', ['cvcheck'=>$service->url]) }}"><img src="{{ asset('services/images/'.$service->service_image) }}" style="height: auto; width: 100%"  alt="image" title="{{ $service->service_name }}"></a>
                            <div class="card-body text-center">
                                <a href="{{ route('cvcheck.cvheckShow', ['cvcheck'=>$service->url]) }}" class="col-md-6 btn text-center" style="background-color: #B61924; border-radius: 10px; color: white">Buy Now</a>
                            </div>
                        </div>
                    </div>
               @endforeach
