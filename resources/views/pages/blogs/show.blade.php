                    ...
                    <div class="card-body" style="border-bottom: 1px solid silver">
                        <ul>
                            @foreach($side_blogs as $side_blog)
                                <li style="color: red; font-family: 'Hind Siliguri'; font-size: 18px"><a href="{{ route('pages.blogs.show', ['name'=>$side_blog->url]) }}" style="color: black;">{{ $side_blog->blog_name }}</a></li>
                            @endforeach
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <ul>
                            @foreach($most_like as $most_likes)
                                <li style="color: red; font-family: 'Hind Siliguri'; font-size: 18px"><a href="{{ route('pages.blogs.show', ['name'=>$most_likes->url]) }}" style="color: black;">{{ $most_likes->blog_name }} <sup class="text-danger"> {{ $most_likes->TotalLike }} Like</sup> </a></li>
                            @endforeach
                        </ul>
                    </div>
                </div>
