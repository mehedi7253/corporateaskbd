            ...
            <div class="card">
                <div class="header">
                    ...
                    <ul class="header-dropdown m-r--5">
                        <a href="{{ route('bookorders.index') }}" class="btn btn-primary">Complete Orders</a>
                    </ul>
                </div>
                <div class="body">
                            ...
                            <tbody>
                                @foreach($orders as $i=>$order)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('bookorders.show', $order->id) }}" class="btn btn-primary"><i class="fa fa-eye"></i></a>
                                        </td>
                                    </tr>
                                    @endif
                                @endforeach
