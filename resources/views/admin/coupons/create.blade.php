    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="body">
                    <form action="{{ route('coupon-codes.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row clearfix">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <input id="coupon_code" type="text" class="form-control @error('coupon_code') is-invalid @enderror" name="coupon_code" value="{{ old('coupon_code') }}" placeholder="Enter Coupon Code" autocomplete="coupon_code" autofocus>
                                    </div>
                                    @error('coupon_code')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <input id="discount" type="number" min="1" class="form-control @error('discount') is-invalid @enderror" name="discount" value="{{ old('discount') }}">
                                    </div>
                                    @error('discount')
                                    <span class="invalid-feedback" role="alert">
                                         <label style="color: red">{{ $message }}</label>
                        ...
                        <div class="row clearfix">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="radio" name="status" id="male" value="0" checked class="with-gap">
