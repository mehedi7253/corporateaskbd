                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $product->name }}" placeholder="Enter Package Name" autocomplete="name" autofocus>
                                    </div>
                                    @error('name')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <input id="price" type="number" min="1" class="form-control @error('price') is-invalid @enderror" name="price" value="{{  $product->price }}" placeholder="Enter Package Price" autocomplete="price" autofocus>
                                    </div>
                                    @error('price')
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <input id="default_discount" type="number" min="0" class="form-control @error('default_discount') is-invalid @enderror" name="default_discount" value="{{  $product->default_discount }}" placeholder="Enter Discount Price" autocomplete="default_discount" autofocus>
                                    </div>
